...
| [What We Don’t See](https://l69d.github.io/art-of-data/holes/) | [Wald's bombers: 300 simulated sorties, holes per plane by part](holes/) — a four-minute interactive film, every frame drawn live | WebGL2 + WebAudio, no libraries, offline |
...
![What We Don’t See: holes per plane on the planes that came home and the planes that didn’t](holes/preview.png)
...
- **2026-09-26** — What We Don't See: Wald's bombers alone, as a four-minute interactive
